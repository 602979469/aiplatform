...
class AiPlatformExceptionTest {
    ...
    void ofThrowShouldKeepEnumCodeAndMessage() {
        AiPlatformException exception = AiPlatformException.ofThrow(ErrorCodeEnum.USERNAME_EXISTS);
    ...
    void ofThrowShouldAllowCustomMessage() {
        AiPlatformException exception = AiPlatformException.ofThrow(ErrorCodeEnum.USERNAME_EXISTS, "该用户名已被占用");
