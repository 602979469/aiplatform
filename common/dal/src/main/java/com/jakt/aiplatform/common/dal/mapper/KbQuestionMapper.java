 ...
 * 查询参数使用 common-dal 的 KbQuestionDalQuery，common-dal 不依赖 core-model。
 */
@Mapper
public interface KbQuestionMapper {
     ...
     * @return 题库数据对象
     */
    KbQuestionDO selectById(Long id);
     ...
     * @return 当前页数据
     */
    List<KbQuestionDO> selectPage(KbQuestionDalQuery query);
     ...
     * @return 全量数据
     */
    List<KbQuestionDO> selectList(KbQuestionDalQuery query);
     ...
     */
    KbQuestionDO selectOne(KbQuestionDalQuery query);
     ...
     * @return 总条数
     */
    long countByQuery(KbQuestionDalQuery query);

    /**
     * 新增，返回受影响行数；自增主键回填到入参 DO。
     *
     * @param kbQuestionDO 数据对象
     * @return 受影响行数
     */
    int insert(KbQuestionDO kbQuestionDO);
     ...
     * @return 受影响行数
     */
    int update(KbQuestionDO kbQuestionDO);
     ...
     *
     * @param kbQuestionDO 数据对象（至少含主键）
     * @return 受影响行数
     */
    int updateByCondition(KbQuestionDO kbQuestionDO);
