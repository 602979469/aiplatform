 ...
 * 试卷题目快照与作答管理类接口定义
 */
public interface KbExamPaperQuestionManager {

    /**
     * 创建试卷题目快照与作答
     *
     * @param kbExamPaperQuestion 试卷题目快照与作答
     * @return 创建成功后的试卷题目快照与作答
     */
     ...
     * @return 分页结果
     */
    PageResult<KbExamPaperQuestion> pageKbExamPaperQuestions(KbExamPaperQuestionQueryParam query);
     ...
     * @return 试卷题目快照与作答列表
     */
    List<KbExamPaperQuestion> listKbExamPaperQuestions(KbExamPaperQuestionQueryParam query);
