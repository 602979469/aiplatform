 ...
 * 试卷模板管理类接口定义
 */
public interface KbExamTemplateManager {
     ...
     * @return 分页结果
     */
    PageResult<KbExamTemplate> pageKbExamTemplates(KbExamTemplateQueryParam query);
     ...
     * @return 试卷模板列表
     */
    List<KbExamTemplate> listKbExamTemplates(KbExamTemplateQueryParam query);
