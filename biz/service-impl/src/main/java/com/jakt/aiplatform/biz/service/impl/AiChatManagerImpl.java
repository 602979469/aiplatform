...
public class AiChatManagerImpl implements AiChatManager {
    ...
    /** AI 对话领域服务（会话聚合根：会话 + 消息 + 对话用例）。 */
    private final AiChatService aiChatService;

    public AiChatManagerImpl(AiChatService aiChatService) {
    ...
    public List<AiChatSession> listSessions() {
        ...
        return aiChatService.findList(query);
    }
    ...
    public AiChatSession createSession() {
        ...
        AiChatSession created = aiChatService.createAiChatSession(session);
    ...
    public void renameSession(Long sessionId, String sessionName) {
        ...
        aiChatService.updateByCondition(update);
    ...
    public void deleteSession(Long sessionId) {
        checkOwner(sessionId);
        aiChatService.deleteAiChatSession(sessionId);
    ...
    public List<AiChatMessage> listMessages(Long sessionId) {
        checkOwner(sessionId);
        return aiChatService.findMessagesBySessionAsc(sessionId);
    }
    ...
    private AiChatSession checkOwner(Long sessionId) {
        AiChatSession session = aiChatService.getAiChatSession(sessionId);
